...
const Carrusel = () => {
    ...
    return (
        <div id="carruselCódigo" className="carousel slide carousel-dark shadow border border-light rounded-3" data-bs-ride="carousel" style={{ height: "21.5em", width: "35em" }}>
