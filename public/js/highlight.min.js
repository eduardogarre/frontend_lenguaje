/*!
  Highlight.js v11.5.0 (git: ded24ce3b0)
...
;n+=S.substr(e),M.addText(n)}function d(){null!=N.subLanguage?(()=>{
...
const t=e[0],i=n.substr(e.index),r=p(N,e,i);if(!r)return te;const s=N
